  ...
  return (
    <div className=" relative grid gap-2  grid-cols-[2fr_1fr] lg:mx-7 rounded-3xl overflow-hidden">
      <div className="flex">
        ...
        {placeData.photos?.[0] && (
          <img
            src={`https://hotel-booking-6-277c.onrender.com/uploads/${placeData.photos[0]}`}
            alt=""
      ...
      <div className="grid  gap-2 ">
        {placeData.photos?.[1] && (
          <img
            src={`https://hotel-booking-6-277c.onrender.com/uploads/${placeData.photos[1]}`}
            alt=""
        ...
        <div className="">
          {placeData.photos?.[2] && (
            <img
              src={`https://hotel-booking-6-277c.onrender.com/uploads/${placeData.photos[2]}`}
              alt=""
              className="aspect-square  object-cover cursor-pointer"
              onClick={() => setShowAllPhoto(true)}
            />
      ...
      <button
        onClick={() => setShowAllPhoto(true)}
        className=" bg-white p-2 m-3 absolute bottom-0 right-0 rounded-2xl cursor-pointer shadow-md hover:shadow-gray-900"
      >
